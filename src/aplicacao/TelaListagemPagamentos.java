...
public class TelaListagemPagamentos extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaListagemPagamentos frame = new TelaListagemPagamentos();
		...
		btnCriar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
					...
					textArea.setText(Sistema.listarPagamentos());
				}
