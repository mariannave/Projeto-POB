...
//			//CADASTRANDO FUNCIONARIO;
			...
			Sistema.cadastroFuncionario("Laura Rocha Oliveira", "Manicure");
			Sistema.cadastroFuncionario("Ana Ferreira Souza", "Cabelereira");
			Sistema.cadastroFuncionario("Leila Sousa Azevedo", "Colorista");
			Sistema.cadastroFuncionario("Raissa Costa Rodrigues", "Esteticista");
